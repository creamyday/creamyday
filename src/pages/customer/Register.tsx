...
const cityAreaMap: Record<string, string[]> = {
  ...
  苗栗縣: [
    "苗栗市","苑裡鎮","通霄鎮","竹南鎮","頭份市","後龍鎮","卓蘭鎮",
    "大湖鄉","公館鄉","銅鑼鄉","南庄鄉","頭屋鄉","三義鄉","西湖鄉",
    "造橋鄉","三灣鄉","獅潭鄉","泰安鄉"
  ],

  彰化縣: [
    "彰化市","鹿港鎮","和美鎮","線西鄉","伸港鄉","福興鄉","秀水鄉",
  ...
  花蓮縣: [
    "花蓮市","鳳林鎮","玉里鎮","新城鄉","吉安鄉","壽豐鄉","光復鄉",
    "豐濱鄉","瑞穗鄉","富里鄉","秀林鄉","萬榮鄉","卓溪鄉"
  ],

  台東縣: [
    "台東市","成功鎮","關山鎮","卑南鄉","鹿野鄉","池上鄉","東河鄉",
    "長濱鄉","太麻里鄉","大武鄉","綠島鄉","海端鄉","延平鄉",
    "金峰鄉","達仁鄉","蘭嶼鄉"
  ],
...
export default function Register() {
            ...
            <div className="row mb-3 align-items-center">
              ...
              <div className="col-md-7">
                ...
                {Array.from([errors.email, errors.isEmailTo])
                  ...
                  .map((error, index) => (
                    <span
                      className="text-danger d-inline-block me-1"
                      key={index}
                    >
                      {error?.message}
                    </span>
  ...
  <div className="col-md-10">
    <div className="d-flex gap-2 address-group">
